...
from .forms import ItemForm,ShipmentForm,OrderForm
from .models import Item,Shipment,Order,Product
...
def get_inventory(request):
    ...
    if not search.strip():
        return redirect('/')
    final_url = 'https://www.canadacomputers.com/search/results_details.php?language=en&keywords=%s' %search
